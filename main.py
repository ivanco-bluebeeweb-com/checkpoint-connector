...
instance -- same pattern as every other SASE connector's main.py.
"""
...
_LOCAL = (
    "app", "schemas", "checkpoint_client",
    "handlers_connection", "handlers_objects", "handlers_access",
    "handlers_bulk_audit",
...
import handlers_access  # noqa: E402,F401
